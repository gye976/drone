...
void Mpu6050::read_fifo(float acc[], float gyro[])
{
	...
	ret = read(_i2c_fd, buf, fifo_count); // fifocount ?
...
void Mpu6050::do_mpu6050(float dt)
{
	...
	gyro_rate_to_angle(_gyro_rate, new_gyro_angle, dt);
